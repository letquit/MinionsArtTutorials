...
public class TMP_SDFShaderGUIGlitch : TMP_BaseShaderGUI
{
    ...
    void DoGlitchPanel()
    {
        ...
        DoSlider("_GlitchOffset", "GlitchOffset");
        DoSlider("_GlitchOffset2", "GlitchOffset2");
        DoSlider("_GlitchTime", "GlitchTime");
        DoSlider("_GlitchAmount", "GlitchAmount");
        DoSlider("_ScanLinesAmount", "Scanlines Amount");
        DoSlider("_ScanLinesOpacity", "Scanlines Opacity");
        DoSlider("_ScanLinesSpeed", "Scanlines Speed");
        DoVector2("_SplitChannelG", "Split Channel G Offset");
        DoVector2("_SplitChannelB", "Split Channel B Offset");
        EditorGUI.indentLevel -= 1;
